...
//==========================================================================================================================
#ifdef OF_CLIENT_DLL
CRagdollEnumerator::CRagdollEnumerator( Ray_t& shot, int iDamageType, int iDamage )
#else
...
IterationRetval_t CRagdollEnumerator::EnumElement( IHandleEntity *pHandleEntity )
{
	...
	{
#ifdef OF_CLIENT_DLL
		pModel->ImpactTrace( &tr, m_iDamageType, NULL, m_iDamage );
#else
...
//-----------------------------------------------------------------------------
#ifdef OF_CLIENT_DLL
bool FX_AffectRagdolls( Vector vecOrigin, Vector vecStart, int iDamageType, int iDamage )
#else
...
#ifdef OF_CLIENT_DLL
	CRagdollEnumerator ragdollEnum( shotRay, iDamageType, iDamage );
#else
...
{
#ifdef OF_CLIENT_DLL
	FX_AffectRagdolls( data.m_vOrigin, data.m_vStart, data.m_nDamageType, data.m_nAttachmentIndex );
#else
...
//-----------------------------------------------------------------------------
#ifdef OF_CLIENT_DLL
bool Impact( Vector &vecOrigin, Vector &vecStart, int iMaterial, int iDamageType, int iHitbox, C_BaseEntity *pEntity, trace_t &tr, int nFlags, int maxLODToDecal, int iDamage )
#else
...
#endif
{
	...
	{
#ifdef OF_CLIENT_DLL
		bHitRagdoll = FX_AffectRagdolls( vecOrigin, vecStart, iDamageType, iDamage );
#else
...
#ifdef OF_CLIENT_DLL
	iDamage = data.m_nAttachmentIndex;
#endif
