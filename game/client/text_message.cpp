...
{
public:
	virtual const char *LocaliseTextString( const char *msg, char *dst_buffer, int buffer_size );
	virtual const char *BufferedLocaliseTextString( const char *msg );
...
// Output : char
//-----------------------------------------------------------------------------
const char *CHudTextMessage::LocaliseTextString( const char *msg, char *dst_buffer, int buffer_size )
{
	char *dst = dst_buffer;
...
// Output : char
//-----------------------------------------------------------------------------
const char *CHudTextMessage::BufferedLocaliseTextString( const char *msg )
{
