...
extern vgui::VPANEL GetGameUIChildByName(vgui::Panel *panel, const char *name);
extern vgui::Panel *GetGameUIPanel(vgui::VPANEL panel);
extern vgui::Panel *GetGameUIRootPanel();
