...
void CBaseModFrame::Hide()
{
	...
	bool bDeleteSelfOnClose = ShouldDeleteSelfOnClose();
	SetDeleteSelfOnClose( false );

	BaseClass::OnClose();

	SetDeleteSelfOnClose( bDeleteSelfOnClose );

	CBaseModPanel::GetSingleton().OnFrameHidden( pri, wt );
}
