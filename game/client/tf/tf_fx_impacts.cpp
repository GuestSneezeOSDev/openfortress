...
void ImpactCallback( const CEffectData &data )
{
	...
	C_BaseEntity *pEntity = ParseImpactData( data, &vecOrigin, &vecStart, &vecShotDir, nSurfaceProp, iMaterial, iDamageType, iHitbox, iDamage );
#else
...
#ifdef OF_CLIENT_DLL
		if ( Impact( vecOrigin, vecStart, iMaterial, iDamageType, iHitbox, pEntity, tr, 0, -1, iDamage ) )
#else
