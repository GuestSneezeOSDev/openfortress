...
{
	static std::wstring wsTip;
    static const wchar_t* noTip = L"Couldn't find a tip! Try reinstalling your game!";
	...
	std::wstring wsFmt = std::wstring(wzFmt);
	// replace any commands with their bound keys
	wsTip = UTIL_ReplaceKeyBindings(wsFmt);
