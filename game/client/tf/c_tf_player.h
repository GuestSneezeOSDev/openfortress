...
public:
	...
	//void CreatePiercedLegsEffect(void);
...
public:
	...
	// int		GetMaxAmmo( int iAmmoIndex, int iClassNumber = -1, int iModifier = -1 );
...
public:
	...
	virtual void HandleTaunting( void );
...
private:
	...
	*/
	...
	// PiercedLegs particle effect
	//CNewParticleEffect	*m_pPiercedLegsEffect;
...
public:
	...
	CHandle<C_PlayerAttachedModel>	m_hJetpack;
...
public:
	...
	void ImpactTrace( trace_t *pTrace, int iDamageType, const char *pCustomImpactName, int iDamage );
...
private:
	...
	int m_iHealthHead;
	int m_iHealthLeftArm;
	int m_iHealthRightArm;
	int m_iHealthLeftLeg;
	int m_iHealthRightLeg;
