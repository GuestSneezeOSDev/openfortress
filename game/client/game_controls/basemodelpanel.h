...
public:
	CModelPanelModelInfo()
	{
		...
		m_vecAbsAnglesAnim.Init();
		m_vecOriginOffsetAnim.Init();
	...
	Vector GetAngles() { return m_vecAbsAngles + m_vecAbsAnglesAnim; }
	Vector GetOrigin() { return m_vecOriginOffset + m_vecOriginOffsetAnim; }
...
public:
	...
	Vector		m_vecAbsAnglesAnim;
	Vector		m_vecOriginOffsetAnim;
...
#endif
#ifdef OF_CLIENT_DLL	
	virtual void GetHUDModelPos( float &x, float &y, float &z ) override;
	virtual void SetHUDModelPos( float x, float y, float z ) override;
	
	virtual void GetHUDModelAng( float &x, float &y, float &z ) override;
	virtual void SetHUDModelAng( float x, float y, float z ) override;

	virtual void GetHUDModelAnimPos( float &x, float &y, float &z ) override;
	virtual void SetHUDModelAnimPos( float x, float y, float z ) override;
	
	virtual void GetHUDModelAnimAng( float &x, float &y, float &z ) override;
	virtual void SetHUDModelAnimAng( float x, float y, float z ) override;
