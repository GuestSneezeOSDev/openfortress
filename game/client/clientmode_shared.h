...
#ifdef OF_CLIENT_DLL
	static const char* GetAnnouncer();

	static SoundData_t *PlayAnnouncerLine( const char *szSound, bool bAnnouncer = false );
	static SoundData_t *PlayTeamAnnouncerLine( const char* szSound, int iTeam, bool bAnnouncer = false, int iPlayer = -1 );
	static SoundData_t *PlayFFAAnnouncerLine( const char* szSound, const char *szSoundRest, int iPlayer, bool bAnnouncer = false );
#endif
