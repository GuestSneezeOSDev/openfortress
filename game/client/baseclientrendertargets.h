...
#ifdef OF_CLIENT_DLL
	// Used to fix the Model Panel not rendering off screen bug
	CTextureReference		m_ModelPanelTexture;
#endif
...
#ifdef OF_CLIENT_DLL
	ITexture* CreateModelPanelTexture( IMaterialSystem* pMaterialSystem );
#endif
};
