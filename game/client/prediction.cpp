...
ConVar	cl_lagcompensation	( "cl_lagcompensation","1", FCVAR_CHEAT | FCVAR_HIDDEN | FCVAR_USERINFO | FCVAR_NOT_CONNECTED, "Perform server side lag compensation of weapon firing events." );
...
// TODO:  Check for impulse predicted?
...
#ifdef OF_CLIENT_DLL
	player->m_bServersideWeaponSwitch = true;
#endif
	// Do weapon selection
	if ( ucmd->weaponselect != 0 )
	{
		...
		{
#ifdef OF_CLIENT_DLL
			player->m_bServersideWeaponSwitch = false;
#endif
