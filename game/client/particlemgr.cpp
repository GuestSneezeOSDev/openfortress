...
bool CParticleMgr::EarlyRetireParticleSystems( int nCount, ParticleSimListEntry_t *ppEffects )
{
	...
	size_t nDefCount = 0;
	CParticleSystemDefinition **ppDefs = (CParticleSystemDefinition**)calloc( sizeof(CParticleSystemDefinition*), nCount );
	...
	RetireInfo_t *pInfo = (RetireInfo_t*)calloc( nSize, 1 );
