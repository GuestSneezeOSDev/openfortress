...
#ifdef OF_CLIENT_DLL
// Impact Trace which stores damage
void	UTIL_ImpactTraceDamage( trace_t *pTrace, int iDamageType, int iDamage, const char *pCustomImpactName = NULL );
#endif
...
#if defined( OF_CLIENT_DLL ) && !defined( UTIL_VarArgs )
