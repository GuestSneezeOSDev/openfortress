...
public:
	...
	virtual const char* GetPowerupRespawnLine(void);
	virtual const char* GetPowerupPickupLine(void);
	virtual const char* GetPowerupPickupLineSelf(void);
	virtual const char* GetPowerupPickupSound(void);
	virtual const char* GetPowerupPickupIncomingLine(void);
	...
	CNetworkVar(bool, m_bDisableIdleSound );
	CNetworkVar(bool, m_bShouldIdleSoundPlay);
