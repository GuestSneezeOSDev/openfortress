...
//-----------------------------------------------------------------------------
bool CFuncFilterVisualizer::ShouldCollide( int collisionGroup, int contentsMask, CBaseEntity *pEnt ) const
{
	if( !pEnt )
		return false;

	return const_cast<CFuncFilterVisualizer*>(this)->PassesTriggerFilters(pEnt);
}