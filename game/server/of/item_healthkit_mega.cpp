...
CHealthKitMega::CHealthKitMega()
{
	m_iszPickupSound = MAKE_STRING("HealthKitMega.Touch");
}
...
const char* CHealthKitMega::GetPowerupPickupLineSelf(void)
{
	return "MegahealthTakenSelf";
}

const char* CHealthKitMega::GetPowerupPickupLine(void)
{
	return "MegahealthTaken";
}

const char* CHealthKitMega::GetPowerupRespawnLine(void)
{
	return "Megahealth";
}

const char* CHealthKitMega::GetPowerupPickupIncomingLine(void)
{
	return "MegaHealthIncoming";
}