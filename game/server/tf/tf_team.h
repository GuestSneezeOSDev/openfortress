...
#endif
	virtual int	GetNumQuotaBots( void ) { return m_iNumQuotaBots; }
	virtual int	GetNumLockdownBots(void) { return m_iNumLockdownBots; }
private:
	...
	CNetworkVar( int, m_iNumQuotaBots );
	CNetworkVar( int, m_iNumLockdownBots );
};
