...
#ifdef OF_DLL
	//	New impact trace which allows us to store damage ( used for dismemberment )
	virtual void			ImpactTrace( trace_t *pTrace, int iDamageType, const char *pCustomImpactName = NULL, int iDamage = 0 );
#else
