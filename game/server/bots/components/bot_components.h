...
public:
    virtual bool GetEntityBestAimPosition( CBaseEntity *pTarget, Vector &vecResult );
...
public:
	...
	CountdownTimer m_AttackHoldDownTimer;
	CountdownTimer m_Attack2HoldDownTimer;
};
...
public:
	...
	virtual bool ShouldGrabSpawner( CWeaponSpawner *pSpawner ) const;
	virtual bool ShouldGrabPowerup( CCondPowerup *pPowerup) const;
	virtual bool ShouldGrabHealthKit( CHealthKit *pHealthKit ) const;
	virtual bool ShouldGrabAmmoPack( CAmmoPack *pAmmoPack ) const;

	virtual void ScanAllWeaponsRange();

	virtual bool ShouldUseThisWeaponForThis( CBaseWeapon *pGivenWeapon, bool bIsReloadCheck ) const;
#endif
	...
	//virtual void ScanAllWeaponsForTrinity();
	//virtual void ScanAllWeaponsForRange();
	//virtual void IdleTrinityChecks();
