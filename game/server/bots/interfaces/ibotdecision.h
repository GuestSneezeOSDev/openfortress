...
#ifdef OF_DLL
	virtual bool ShouldGrabSpawner( CWeaponSpawner *pWeapon ) const = 0;
	virtual bool ShouldGrabPowerup( CCondPowerup *pPowerup) const = 0;
	virtual bool ShouldGrabHealthKit( CHealthKit *pHealthKit) const = 0;
	virtual bool ShouldGrabAmmoPack(CAmmoPack *pAmmoPack) const = 0;
#endif
