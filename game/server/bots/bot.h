...
extern const char* GetRandomPlayerName();
...
public:
    ...
    virtual void OnLookedEntity( CBaseEntity *pEntity );
    ...
    virtual void SetRemoveOnDeath( bool bRemoveOnDeath ){ m_bRemoveOnDeath = bRemoveOnDeath; }
    virtual bool RemoveOnDeath() { return m_bRemoveOnDeath; }
...
// Artificial Intelligence to create a player controlled by the computer
//================================================================================
class COFBot : public IBot
{
public:
	DECLARE_CLASS_GAMEROOT(COFBot, IBot);

	COFBot(CBasePlayer *parent);
