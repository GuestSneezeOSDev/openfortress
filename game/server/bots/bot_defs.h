...
// Derived classes
#ifdef OF_DLL
typedef CTFPlayer CPlayer;
typedef CTFWeaponBase CBaseWeapon;
// Similar functions
#define ToInPlayer ToTFPlayer
#define ToBaseWeapon dynamic_cast<CTFWeaponBase *>
#define TheGameRules TFGameRules()
#define GetGameDifficulty() TheGameRules->GetSkillLevel()
#define GetActiveBaseWeapon GetActiveTFWeapon
#else
...
#ifdef OF_DLL
#define GetWeaponInfo GetTFWpnData
#else
...
*/
#define SKILL_EASIEST SKILL_EASY
#define SKILL_HARDEST SKILL_EXPERT
// Sounds
...
#define BOT_DESIRE_COVER_HEAVY_DAMAGE 0.9f
#define BOT_DESIRE_COVER_REPEATED_DAMAGE 0.85f
#define BOT_DESIRE_COVER_DANGEROUS_ENEMY 0.84f
#define BOT_DESIRE_COVER_BASE_COMBAT 0.1

#define BOT_DESIRE_RELOAD_COMBAT 0.91f
#define BOT_DESIRE_RELOAD_OUT_OF_COMBAT 0.43f

#define BOT_DESIRE_PICKUP_POWERUP 0.85f

#define BOT_DESIRE_PICKUP_SPAWNER_HELPLESS 0.9f
#define BOT_DESIRE_PICKUP_SPAWNER_NEW 0.8f
#define BOT_DESIRE_PICKUP_SPAWNER_REFILL 0.7f

#define BOT_DESIRE_PICKUP_AMMO 0.25f

#define BOT_DESIRE_PICKUP_HEALTH_CRITICAL 0.90f
#define BOT_DESIRE_PICKUP_HEALTH_LARGE 0.75f
#define BOT_DESIRE_PICKUP_HEALTH_MEDIUM 0.50f
#define BOT_DESIRE_PICKUP_HEALTH_SMALL 0.30f
#define BOT_DESIRE_PICKUP_HEALTH_TINY 0.10f

#define BOT_DESIRE_HUNT_LOST_ENEMY 0.65f

#define BOT_DESIRE_HUNT_FAR_ENEMY 0.38f

// CTF BULLSHIT

/*
#define BOT_DESIRE_GOTO_FLAG 0.10f
#define BOT_DESIRE_DEFEND_FLAG 0.09f

#define BOT_DESIRE_CAP_FLAG 0.49f
#define BOT_DESIRE_DEFEND_TAKEN_FLAG 0.48f
*/

#define BOT_DESIRE_GOTO_FLAG 0.10f
#define BOT_DESIRE_GOTO_DROPPED_FLAG 0.29f
#define BOT_DESIRE_GOTO_CAPTURE_FLAG 0.49f
...
#define BOT_DESIRE_FREE_ROAM 0.01f

// unused

#define BOT_DESIRE_STRAFE_COMBAT 0.70f
#define BOT_DESiRE_STRAFE_ALERTED 0.14f
#define BOT_DESIRE_STRAFE_IDLE 0.13f
...
enum
{
	...
	SCHEDULE_PICKUP_SPAWNER,
	SCHEDULE_PICKUP_POWERUP,
	SCHEDULE_FIND_HEALTH,
	SCHEDULE_FIND_AMMO,

	SCHEDULE_CAPTURE_FLAG,

	SCHEDULE_GOTO_FLAG,
	SCHEDULE_DEFEND_OWN_FLAG,
	SCHEDULE_FREE_ROAM,
...
enum
{
	...
	BTASK_DECIDE_NEW_ROAM_LOCATION,
	...
	BTASK_PICKUP_SPAWENER,
	BTASK_PICKUP_POWERUP,
	BTASK_FIND_HEALTH,
	BTASK_FIND_AMMO,
...
enum BCOND
{
	...
	BCOND_EMPTY_CURRENT_AMMO,
	BCOND_LOW_CURRENT_AMMO,
	...
	BCOND_EMPTY_TERTIARY_AMMO,
	BCOND_LOW_TERTIARY_AMMO,
	...
	BCOND_POWERUP_AVAILABLE,
	BCOND_HEALTH_PICKUP_AVAIBLE,
	BCOND_AMMO_PICKUP_AVAIBLE,

	BCOND_OVERHEAL_HEALTH,
	BCOND_FULL_HEALTH,
	BCOND_HIGH_HEALTH,
	BCOND_MID_HEALTH,
	BCOND_LOW_HEALTH,
	BCOND_CRITICAL_HEALTH,
