...
void CTFLightningGun::WeaponSound( WeaponSound_t sound_type, float soundtime )
{
...
void CTFLightningGun::SetParticleEnd()
{
	...
	// Use CONTENTS_HITBOX otherwise the visual tracer we fire hits bounding boxes! -sappho
	UTIL_TraceLine( vecShootPos, endPos, ( MASK_SOLID | CONTENTS_HITBOX ), &filter, &tr );
