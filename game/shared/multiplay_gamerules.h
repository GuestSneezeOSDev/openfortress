...
// Voice commands - shared
	virtual int ActiveVoiceCommandSetId() const;
...
// Voice commands
	...
	const SVoiceCommand* VoiceCommand(CBaseMultiplayerPlayer *pPlayer, const char *szGlobalIdentifier) const;
	const SVoiceCommand* VoiceCommand(CBaseMultiplayerPlayer *pPlayer, unsigned int uMenu, unsigned int uItem) const;
...
protected:
	...
	virtual bool PlayVoiceCommand(CBaseMultiplayerPlayer* pPlayer, const SVoiceCommand& voiceCommand, bool bIsCalledFromBind) const;
...
public:
// Voice commands
	const char *GetVoiceCommandSubtitle(unsigned int iMenu, unsigned int iItem) const;
	bool GetVoiceMenuLabels(unsigned int iMenu, KeyValues *pKV) const;

#endif // !CLIENT_DLL

private:
	CVoiceCommandRegistry* m_pVoiceCommandRegistry;
};
