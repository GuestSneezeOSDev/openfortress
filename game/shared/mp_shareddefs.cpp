...
const char *g_pszMPConcepts[] =
{
	...
	"TLK_TAUNT_KNUCKLES",			// MP_CONCEPT_PLAYER_TAUNT_KNUCKLES
	"TLK_TAUNT_SO_CLOSE",			// MP_CONCEPT_PLAYER_TAUNT_SOCLOSE
	"TLK_TAUNT_GROOVY",				// MP_CONCEPT_PLAYER_TAUNT_GROOVY
	"TLK_TAUNT_DEAD_MEAT",			// MP_CONCEPT_PLAYER_TAUNT_DEADMEAT
	"TLK_TAUNT_BOND",				// MP_CONCEPT_PLAYER_TAUNT_BOND
	"TLK_TAUNT_BOMB_SCARE",			// MP_CONCEPT_PLAYER_TAUNT_BOMB_SCARE
	"TLK_TAUNT_CUSTOM",				// MP_CONCEPT_PLAYER_TAUNT_CUSTOM
#endif
};
