...
void CSprayBanMgr::SaveState( const char *pGameDir )
{
	const char *pSaveDir = g_pBanMgrFilename;
	g_pBanMgrFilename = "spray_ban.dt";

	CVoiceBanMgr::SaveState( pGameDir );

	g_pBanMgrFilename = pSaveDir;
}

bool CSprayBanMgr::Init( const char *pGameDir )
{
	const char *pSaveDir = g_pBanMgrFilename;
	g_pBanMgrFilename = "spray_ban.dt";

	bool bRet = CVoiceBanMgr::Init( pGameDir );
