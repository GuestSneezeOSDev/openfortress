...
// Purpose:
//-----------------------------------------------------------------------------
CTFProjectile_Syringe *CTFProjectile_Syringe::Create(const Vector &vecOrigin, const QAngle &vecAngles, CBaseEntity *pOwner, CBaseEntity *pScorer, int bCritical, float flSpeed)
{
	return static_cast<CTFProjectile_Syringe*>(CTFBaseProjectile::Create("tf_projectile_syringe", vecOrigin, vecAngles, pOwner, flSpeed == -1 ? CTFProjectile_Syringe::GetInitialVelocity() : flSpeed, g_sModelIndexSyringe, SYRINGE_DISPATCH_EFFECT, pScorer, bCritical));
}
...
// Purpose:
//-----------------------------------------------------------------------------
CTFProjectile_Nail *CTFProjectile_Nail::Create(const Vector &vecOrigin, const QAngle &vecAngles, CBaseEntity *pOwner, CBaseEntity *pScorer, int bCritical, float flSpeed)
{
	CTFProjectile_Nail *pNail = static_cast<CTFProjectile_Nail*>(CTFBaseProjectile::Create("tf_projectile_nail", vecOrigin, vecAngles, pOwner, flSpeed == -1 ? CTFProjectile_Nail::GetInitialVelocity() : flSpeed, g_sModelIndexNail, NAILGUN_NAIL_DISPATCH_EFFECT, pScorer, bCritical));
...
// Purpose:
//-----------------------------------------------------------------------------
CTFProjectile_Tranq *CTFProjectile_Tranq::Create(const Vector &vecOrigin, const QAngle &vecAngles, CBaseEntity *pOwner, CBaseEntity *pScorer, int bCritical, float flSpeed)
{
	return static_cast<CTFProjectile_Tranq*>(CTFBaseProjectile::Create("tf_projectile_tranq", vecOrigin, vecAngles, pOwner, flSpeed == -1 ? CTFProjectile_Tranq::GetInitialVelocity() : flSpeed, g_sModelIndexTranq, TRANQ_DISPATCH_EFFECT, pScorer, bCritical));
}
