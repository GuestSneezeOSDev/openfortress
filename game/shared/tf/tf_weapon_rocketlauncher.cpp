...
acttable_t CTFOriginal::m_acttableRocketLauncher[] =
{
...
acttable_t *CTFOriginal::ActivityList(int &iActivityCount)
{
	if( !GetTFPlayerOwner() )
	...
	{
		iActivityCount = ARRAYSIZE(m_acttableRocketLauncher);
		return m_acttableRocketLauncher;
	}
	else
	{
		return BaseClass::ActivityList(iActivityCount);
