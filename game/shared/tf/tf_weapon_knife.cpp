...
//Act tables for Merc
acttable_t CTFKnife::m_acttableKnife[] =
{
	...
	{ ACT_MP_ATTACK_STAND_MELEE_SECONDARY, ACT_MERC_ATTACK_STAND_KNIFE_BACKSTAB, false},
	{ ACT_MP_ATTACK_STAND_SECONDARYFIRE, ACT_MERC_ATTACK_STAND_KNIFE_BACKSTAB, false },
	{ ACT_MP_ATTACK_CROUCH_SECONDARYFIRE, ACT_MERC_ATTACK_CROUCH_KNIFE_BACKSTAB, false },
	{ ACT_MP_ATTACK_SWIM_SECONDARYFIRE, ACT_MERC_ATTACK_SWIM_KNIFE, false },
	//{ ACT_MP_ATTACK_SWIM_MELEE_SECONDARY, ACT_MERC_ATTACK_SWIM_KNIFE_BACKSTAB, false },
};

acttable_t *CTFKnife::ActivityList(int &iActivityCount)
{
	if( !GetTFPlayerOwner() )
	...
	{
		iActivityCount = ARRAYSIZE(m_acttableKnife);
		return m_acttableKnife;
	}
	return BaseClass::ActivityList(iActivityCount);
}
//-----------------------------------------------------------------------------
...
void CTFKnife::SendPlayerAnimEvent( CTFPlayer *pPlayer )
{
	...
	{
		pPlayer->DoAnimationEvent(PLAYERANIMEVENT_CUSTOM_GESTURE, ACT_MP_ATTACK_STAND_MELEE_SECONDARY);
	}
	else
	{
