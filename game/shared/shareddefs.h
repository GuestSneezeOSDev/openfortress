...
#define MAX_WEAPON_SLOTS		10	// Max 10 because we literally don't have buttons for more, God save us if we go beyond
// max number of items within a slot
#define MAX_WEAPON_POSITIONS	20	// Melees take up the majority of these 20 slots, kind of a waste elsewhere
#else
...
struct FireBulletsInfo_t
{
	FireBulletsInfo_t()
	{
		...
		// Set this a bit higher just in case we're doing clipraytoclient stuff in CTFPlayer::FireBullets 
		// -sappho
		m_flDistance = 16384;
		m_iTracerFreq = 4;
		m_flDamage = 0;
