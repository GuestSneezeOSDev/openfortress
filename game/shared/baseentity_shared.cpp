...
bool CBaseEntity::ShouldCollide( int collisionGroup, int contentsMask, CBaseEntity *pEnt ) const
{
...
void CBaseEntity::ImpactTrace( trace_t *pTrace, int iDamageType, const char *pCustomImpactName, int iDamage )
#else
...
#if defined( OF_CLIENT_DLL ) || defined( OF_DLL )
	// Using attachment index for storing damage
	// since there's no dedicated damage storage
	data.m_nAttachmentIndex = iDamage;
#endif
