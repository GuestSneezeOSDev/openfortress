...
#if defined( OF_DLL ) || defined( OF_CLIENT_DLL )
const char* ReadAndAllocStringName( KeyValues *pSub, const char *pFilename = NULL );
const char* ReadAndAllocStringValue( KeyValues *pSub, const char *pName, const char *pFilename = NULL, const char *pDefault = NULL, bool bReturnNull = false );
#define ReadAndAllocStringValueOrNULL( pSub, pName ) ReadAndAllocStringValue( pSub, pName, NULL, NULL, true )
#else
