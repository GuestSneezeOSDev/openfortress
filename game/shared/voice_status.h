...
public:
	...
	bool	IsPlayerSprayBlocked(int iPlayerIndex);
		// blocks the target client from being heard
	void	SetPlayerSprayBlockedState(int iPlayerIndex, bool blocked);
#endif
...
#if defined( OF_CLIENT_DLL ) || defined( OF_DLL )
	CSprayBanMgr		m_SprayBanMgr;				// Tracks which users we have squelched and don't want to hear.
#endif
