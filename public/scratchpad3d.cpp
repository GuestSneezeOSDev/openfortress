...
void CScratchPad3D::DeleteCommands()
{
	...
	{
		// scratchpad3d.cpp(205,3): warning C5205: delete of an abstract class 'CScratchPad3D::CBaseCommand' that has a non-virtual destructor results in undefined behavior
		// -sappho 
		// delete m_Commands[i];
	}
