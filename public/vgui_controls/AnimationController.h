...
private:
	...
	void AdjustDefaultValues( Panel *panel, UtlSymId_t var, Value_t &value );
	...
	friend bool IsHUDAnimationPlaying(AnimationController* pAnimationControler, const char* seqName, Panel* pWithinParent);
};

// singleton accessor for use only by other vgui_controls
extern AnimationController *GetAnimationController();

extern bool IsHUDAnimationPlaying( AnimationController *pAnimationControler, const char *seqName, Panel *pWithinParent = NULL );
