...
public:
	...
	// completely undefined and dangerous behavior if find returns null. OH WELL!
	...
	//	else
	//	{
	//		// there's no way to safely handle this so just error
	//		Error("Null string from g_pVGuiLocalize->Find\n");
	//	}
	//}
